...
export const BOOST_PRODUCTS: BoostProduct[] = [
  {
    id: 'ai_photo',
    name: 'Обработка фото',
    description: 'Сжатие и оптимизация с сохранением пропорций — работа видна целиком',
    price: 5,
    periodDays: 0,
    icon: '📷',
    features: [
      'Работа видна целиком, без обрезки',
      'Деревянная рамка и паспарту',
      'Сжатие до 800×1000 px',
      'Лёгкий JPEG для быстрой загрузки',
    ],
    popular: true,
  },
  {
