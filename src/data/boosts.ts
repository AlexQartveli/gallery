...
export const BOOST_PRODUCTS: BoostProduct[] = [
  {
    id: 'ai_photo',
    name: 'AI-обработка фото',
    description: 'Gemini анализирует, стандартизирует формат 4:5, сжимает и готовит SEO-метаданные',
    price: 5,
    periodDays: 0,
    icon: '✨',
    features: [
      'Единый формат 800×1000 px',
      'Оптимизация для SEO',
      'Сжатие без потери качества',
      'Автозаполнение названия и описания',
      'Оценка качества съёмки',
    ],
    popular: true,
  },
  {
